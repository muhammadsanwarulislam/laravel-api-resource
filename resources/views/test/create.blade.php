...
<div class="card">
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-4">
                <div class="btn-toolbar float-right" role="toolbar" aria-label="Toolbar with button groups">
                    <a href="{{ route("test.index") }}" class="btn btn-secondary btn-sm ml-1" data-toggle="tooltip" title="{{ $module_title }} List"><i class="fa fa-list-ul"></i> List</a>
                </div>
            </div>
            <!--/.col-->
        </div>
        ...
        <div class="row mt-4">
            <div class="col">
                {{ html()->form('POST', route("test.store"))->class('form')->open() }}
